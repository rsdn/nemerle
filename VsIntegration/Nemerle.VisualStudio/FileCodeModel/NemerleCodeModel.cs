...
namespace Nemerle.VisualStudio.FileCodeModel
{
	...
	public sealed class NemerleProjectCodeModel : CodeModel
	{
		private EnvDTE.Project projectItem;
		internal NemerleProjectCodeModel(EnvDTE.Project project)
		{
		...
		{
			get { return NemerleConstants.LanguageId; }
		}
