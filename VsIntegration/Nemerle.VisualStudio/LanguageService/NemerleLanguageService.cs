	...
	public class NemerleLanguageService : Microsoft.VisualStudio.Package.LanguageService
	{
		...
		private class BracketFinder
		{
			...
			private IEnumerable<ScanTokenInfo> GetTokenIter()
			{
				...
				// 1. ƒл€ первой строки находим токен и начина€ от него сканируем вперед или назад.
		...
		//      //TODO: ƒобавить выдачу сообщений об ошибках парсинга CompileUnit-а!
		//      return null;
		//    }
		...
		//    //TODO: VladD2: –еализовать сравнение старого и нового массива TopDeclaration-ов,
		...
		//    //              запустить перепарсивание дерева типов. Ёто спасет от изменени€ методов
		//    //              которое привело к по€влению новых методов или удалению (например, 
		//    //              в следствии объеденени€) старах.
