...
namespace Nemerle.VisualStudio.GUI.SourceOutliner
{
    ...
    public class SourceOutlinerToolWindow : ToolWindowPane
    {
        ...
        {
            this.Caption = Resources.SourceOutlinerWindowTitle;
        ...
        private void clearFilterButton_Click(object sender, EventArgs e)
        {
            ...
            {
				Utils.DisplayMessage(Resources.ErrorPrefix, "clearFilterButton_Click exception: " + ex.ToString());
            }
        }
        ...
        private void filterStringTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
				Utils.DisplayMessage(Resources.ErrorPrefix, "filterStringTextBox_TextChanged exception: " + ex.ToString());
            }
        }
        ...
        private void toolStripComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
				Utils.DisplayMessage(Resources.ErrorPrefix, "toolStripComboBox_SelectedIndexChanged exception: " + ex.ToString());
            }
        }
        ...
        public void windowsEvents_WindowActivated(EnvDTE.Window gotFocus, EnvDTE.Window lostFocus)
        {
            ...
            {
				Utils.DisplayMessage(Resources.ErrorPrefix, "windowsEvents_WindowActivated exception: " + ex.ToString());
            }
        }
        ...
        private void codeTreeView_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            {
				Utils.DisplayMessage(Resources.ErrorPrefix, "codeTreeView_AfterSelect exception: " + ex.ToString());
            }
        }
        ...
        private void codeTreeView_Enter(object sender, EventArgs e)
        {
            ...
            {
				Utils.DisplayMessage(Resources.ErrorPrefix, "codeTreeView_Enter exception: " + ex.ToString());
            }
        }
        ...
        private void codeTreeView_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
				Utils.DisplayMessage(Resources.ErrorPrefix, "codeTreeView_KeyDown exception: " + ex.ToString());
            }
        }
        ...
        private void codeTreeView_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
				Utils.DisplayMessage(Resources.ErrorPrefix, "codeTreeView_DoubleClick exception: " + ex.ToString());
            }
        }
