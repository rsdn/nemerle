...
\subsection{Runtime program generation}
...
like to check few thing during executon of our macro.
...
(ideed, it can't do this from now on) on provided syntax trees. Such notation
...
\item proceed with typing the rest of the program, executing corresponding
      \verb,Run, method for each occurance of call to macro function.
\end{itemize}
