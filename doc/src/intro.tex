...
We have considered avoiding constructs that produce typing errors in ML, but
syntax errors in other languages (for example function application being
just $\epsilon$); making the typing more explicit, at least for global 
...
to functional languages are appalling because of their elegance, they do 
not fit with the \netf\ at all. Therefore it is easiest to make our \oo\ 
system simply mirror \net\ one.
...
of ML fragment is less ambiguous and more C- than Algol-like.
...
The basic building block of methods is a sequence. A sequence groups local
