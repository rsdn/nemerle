...
\author{Micha³ Moskal, Pawe³ W. Olszta \\ {\small University of Wroc³aw}}
\date{\today}
...
\pagestyle{fancy}
\lhead{Micha³ Moskal, Pawe³ W. Olszta -- \it Nemerle}
\rhead{\thepage}
\cfoot{}
...
In this example both global and local functions are explicitly typed. We
have some basic type inference working for local functions though.
...
recursion (it is in fact implemented as a macro):
