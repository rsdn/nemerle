...
\frametitle{Drzewa sk³adniowe jako dane}
...
\section{Odwo³ywanie siê do procedur kompilatora}

\frame[containsverbatim]{
\frametitle{Typowanie drzew sk³adniowych}
\begin{verbatim}
macro if (cond, e1, e2) {  
...
\begin{itemize}
  ...
  \item kontrola typów przed generacj± kodu
