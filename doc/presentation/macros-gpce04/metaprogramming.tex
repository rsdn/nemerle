...
typing of its parametes can obtain size of supplied tuple. We just need to add
following lines:
...
keep the system simple. Second is to precompile macros, not to end up
with various tricks used to boost up compiler performance (like C++
precompiled headers).
