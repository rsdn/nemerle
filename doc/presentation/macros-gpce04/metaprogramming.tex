...
%\footnote{The Nemerle project is supported 
%by Microsoft Research ROTOR2 grant}}
%
...
\nopagebreak$id(v,current(),g)$ while identifiers introduced with \verb,UseSiteSymbol,
...
macro use-site symbols (similar to our \nopagebreak\verb,UseSiteSymbol(),). All this is done
