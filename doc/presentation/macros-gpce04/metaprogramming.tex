...
Names binding is obvious for programmer of macro, and it's frequently
...
names from single macro execution into the same ``namespace'' which is
...
This is opposite approach to Template Haskell \cite{Haskell:Meta}, 
where lexical scoping means binding immediately at construction of quotation.
We find this quite inflexible and limiting, often leading to manually 
breaking higiene. We lose ability to detect some errors earlier, but as
they are always detected during compilation of generated code, we see it
as minor disadvantage. This way we gain much more freedom to arbitrarily
transform code while still keeping hygienic system.
