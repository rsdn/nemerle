...
\\
{\small\textit{\textbf{.NET Technologies 2004} workshop proceedings, \\
\textbf{ISBN 80-903100-4-4}}} \\ 
Copyright UNION Agency -- Science Press, Plzen, Czech Republic \vspace*{-2mm}}
...
\begin{itemize}
  ...
  \item etc. etc.
\end{itemize}
Of course, the framework is heavily object-orie\-nted and primarily focused on traditional
...
It seems easy to observe that it is the quality of the design of the object-oriented system 
to determine usability of a programming language. While the existing object-oriented extensions 
to functional languages are appealing because of their elegance, they do not fit 
the \netf\ at all. We have decided to make our object-oriented system simply mirror 
the \net\ design.
...
\begin{itemize}
  \item The language is statically typed, but dy\-na\-mic cast are available
...
Top-level program structure reassembles \cs. Th\-ere are namespaces,
...
\begin{itemize}
  ...
  \begin{itemize}
    \item pretty printing generated or original co\-de
  \end{itemize}
