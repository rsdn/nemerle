...
\title{Nemerle\titlenote{\texttt{http://nemerle.org/}}}
\subtitle{Introduction to a Functional .NET Language}
...
\begin{abstract}
  ...
  In this paper we have focused on features absent in traditional ML-like and \oo\ 
  languages:
...
It is also possible to have deep patterns like 
\begin{Code}
Foo (Bar (Baz))
\end{Code}
