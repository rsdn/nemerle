...
functional language fit into the commercial environment. Hence our focus
on easy-of-use and flat learning curve kind of things. We wanted to
develop a platform, that can be later used to bring functional programming
into the industry.
