...
fits the .NET as good as, for example, C\# does.
...
for a functional language) and makes flow control more straightforward 
and therefore making Nemerle programs easier to understand and maintain.
...
useful tools have been written.
