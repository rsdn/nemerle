...
functional language fit into the commercial environment. We have therefore
focused on making the language easy to learn and use. We wanted to develop 
a platform, which would bring functional programming paradigm into the 
industry.
