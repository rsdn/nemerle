...
namespace Microsoft.VisualStudio.Project
{
	...
	public class AssemblyReferenceNode : ReferenceNode
	{
		...
		{
      string result = this.ItemNode.GetEvaluatedMetadata(ProjectFileConstants.HintPath);
      if (String.IsNullOrEmpty(result))
      {
        result = this.ItemNode.GetEvaluatedMetadata(ProjectFileConstants.AssemblyName);
        if (String.IsNullOrEmpty(result))
				{
