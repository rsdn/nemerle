...
namespace Nemerle.VS2010.RegistrationAttributes
{
	...
	public sealed class SingleFileGeneratorSupportRegistrationAttribute : RegistrationAttribute
	{
		...
		/// </summary>
		/// <param name="prjFactoryType">The type of Code generator. Type that implements IVsSingleFileGenerator</param>
		...
		public override void Register(RegistrationContext context)
		{
			...
			{
				// Commented out. This allows the setup to build successfully.
				//
