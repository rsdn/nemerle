...
namespace Nemerle.VisualStudio.Project {
    ...
    class XamlDesignerSupport {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void InitializeEventBindingProviderNoInline(object designerContext, FileNode codeNode)
        {
            Debug.Assert(designerContext is DesignerContext);
            ((DesignerContext)designerContext).EventBindingProvider = new NemerleEventBindingProvider(codeNode);
        }
