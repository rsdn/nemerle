...
namespace Nemerle.VisualStudio.LanguageService
{
	internal static class ClassificationFormats
	{
		...
		{
			public QuotationBraces() { ForegroundColor = Color.FromArgb(0, 128, 128, 0); BackgroundColor = Color.FromArgb(0, 230, 237, 228); }
		}

		[Export(typeof(EditorFormatDefinition))
		, Name("Nemerle Quotation Content")
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationTextName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationKeywordName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationCommentName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationIdentifierName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationStringName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationNumberName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationOperatorName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationStringExName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationVerbatimStringName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationVerbatimStringExName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationRecursiveStringName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationRecursiveStringExName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationUserTypeName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationUserDelegateTypeName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationUserEnumTypeName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationUserInterfaceTypeName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationUserValueTypeName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationToDoCommentName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationBugCommentName)
		, ClassificationType(ClassificationTypeNames = ClassificationTypes.QuotationHackCommentName)
		, UserVisible(true)]
